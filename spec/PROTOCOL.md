...
Generated FIT-profile code in the package maps file type/subtype values including ACTIVITY=4, WEIGHT=9, BLOOD_PRESSURE=14, MONITORING_A=15, MONITORING_B=32 and SLEEP_DATA=49. Garmin Connect also names `FIT_TYPE_44` BIOMETRIC. Gadgetbridge revision `a0948ee1cbc2a870f91d313f8e37df5f524465f7` supplies the public interoperability mapping for additional watch-generated fitness families: metrics/biometric 44, HRV status 68, HSA 70, and skin temperature 73. For directory entries whose data type is the observed FIT family value 128, these subtype names are retained as fitness-data candidates instead of being dropped as unknown manufacturer-range files.
...
### P-0412 — Generic FIT records and activity/wellness projections (`SUPPORTED`, S-0017/S-0024/S-0029/S-0031; T-0077/T-0080/T-0082/T-0083)
